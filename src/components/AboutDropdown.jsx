...
export default function AboutDropdown({ title, textContent }) {
    ...
    return (
        <div className={styles.container}>
            ...
            <svg className={`${isFolded ? '' : styles.fold}`} onClick={toggleFold} width="25" height="14" viewBox="0 0 25 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className={`${styles.unfoldedContent} ${isFolded ? '' : styles.unfold}`}>
                {textContent}
            </p>
        </div>
    )
